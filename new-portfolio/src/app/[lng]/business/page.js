...
import FirstBlock from "@/app/component/business/firstBlock";
import SecondBlockPos from "@/app/component/business/secondBlockPos";

const Business = async ({ params: { lng } }) => {
